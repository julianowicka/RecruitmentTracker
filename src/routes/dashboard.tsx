...
// Lazy load wykresy (bo są duże - recharts)
const StatusPieChart = lazy(() => import('../components/charts/StatusPieChart').then(m => ({ default: m.StatusPieChart })));
const ApplicationsTrendChart = lazy(() => import('../components/charts/ApplicationsTrendChart').then(m => ({ default: m.ApplicationsTrendChart })));
const MonthlyBarChart = lazy(() => import('../components/charts/MonthlyBarChart').then(m => ({ default: m.MonthlyBarChart })));
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-orange-600">
              {stats.averageRecruitmentDays !== null ? stats.averageRecruitmentDays : '-'}
            </div>
            <p className="text-xs text-muted-foreground mt-1">
              {stats.averageRecruitmentDays !== null ? 'dni' : 'Brak danych'}
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        <React.Suspense fallback={<Card><CardContent className="p-6">Ładowanie wykresu...</CardContent></Card>}>
